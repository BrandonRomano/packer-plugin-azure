...
identity](https://packer.io/docs/builder/azure#azure-managed-identity) you
...
To use a [service principal](https://packer.io/docs/builder/azure#azure-active-directory-service-principal)
